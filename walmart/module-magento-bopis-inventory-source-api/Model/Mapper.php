...
use Walmart\BopisInventorySourceApi\Api\Data\PickupLocationInterfaceFactory;
use Magento\InventoryInStorePickupApi\Model\Mapper\PreProcessorInterface;

/**
 * Create projection of sources on for Store Pickup context.
 *
...
class Mapper
{
     ...
     *                                                                   "extension_attributes.source_field" =>
